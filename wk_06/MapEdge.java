...
class MapEdge 
{
	...
	double getLength()
	{
		...
		if (mRoadType == "high") normalizedLength = mLength;
		if (mRoadType == "main") normalizedLength = mLength*1.4;
		if (mRoadType == "state") normalizedLength = mLength*1.2;
		if (mRoadType == "front") normalizedLength = mLength*1.8;
		if (mRoadType == "short") normalizedLength = mLength*2.0;
		if (mRoadType == "first") normalizedLength = mLength*2.4;
		if (mRoadType == "next") normalizedLength = mLength*2.2;
		if (mRoadType == "south") normalizedLength = mLength*1.8;
